                     ...
                     <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
                         <div>
                             <h1 className="text-4xl lg:text-6xl font-black mb-6 leading-[1.1] text-foreground">
                                 The Core of <span className="text-primary">CBAS.</span>
                             </h1>
                             <p className="text-lg text-muted-foreground leading-relaxed mb-8 max-w-md">
                                 Stop losing leads in messy spreadsheets. CBAS surfaces your <strong className="text-foreground font-semibold">Next Best Action</strong>, keeping your sales team focused on closing, not organizing data.
                             </p>
