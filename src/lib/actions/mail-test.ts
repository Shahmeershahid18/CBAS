...
export async function sendTestEmail() {
  ...
  const result = await sendEmail({
    ...
    subject: "🚀 CBAS Email Connection Success!",
    html: `
      <div style="font-family: 'Inter', sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e2e8f0; border-radius: 12px; background-color: #ffffff;">
        ...
        <p style="color: #334155; line-height: 1.6;">Your professional SMTP relay is now correctly configured in <strong>CBAS</strong>.</p>
        ...
        <p style="font-size: 11px; color: #94a3b8; margin-top: 40px;">&copy; 2026 CBAS Automation. All rights reserved.</p>
      </div>
    `,
    text: "Your CBAS email connection is working perfectly! Sent via Brevo SMTP."
  });
